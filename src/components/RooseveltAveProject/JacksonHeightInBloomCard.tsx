...
const CARD_DESCRIPTION =
  "Located at the intersection of 84th Street and Roosevelt Avenue, this inaugural mural reflects the heart of Jackson Heights.";
...
export default function JacksonHeightInBloomCard({
  layout = "column",
}: {
  layout?: "column" | "row";
}) {
  ...
  if (width <= 768) {
    return (
      <div className="flex flex-col  w-full  h-[450px] bg-yellow-500 p-[var(--spacing-lg)]  gap-[var(--spacing-xl)] min-w-0">
  ...
  if (width <= 1200) {
    if (layout === "row") {
      return (
        <div className="flex flex-row w-full h-[450px] bg-yellow-500 p-[var(--spacing-2xl)] gap-[var(--spacing-4xl)] min-w-0">
          ...
          <div className="flex flex-col items-start justify-center w-1/2 gap-[var(--spacing-lg)]">
            ...
            <p className="web-text-s-medium text-[var(--color-content-primary)]">
              {CARD_DESCRIPTION}
            </p>
            <BorderlessButton
              variant="primary"
    ...
    return (
      <div className="flex flex-col w-full h-[600px] bg-yellow-500 p-[var(--spacing-2xl)] min-w-0">
  ...
  if (width <= 1600) {
    if (layout === "row") {
      return (
        <div className="flex flex-row w-full h-[500px] bg-yellow-500 p-[var(--spacing-2xl)] gap-[var(--spacing-8xl)] min-w-0">
          <div className="relative w-1/2 h-full flex-shrink-0 overflow-hidden">
            <Image
              src="/InugrationalMural.jpg"
              alt="Inaugural mural at the intersection of 84th Street and Roosevelt Avenue in Jackson Heights"
    ...
    return (
      <div className="flex flex-col w-full h-[600px] bg-yellow-500 p-[var(--spacing-xl)] gap-[var(--spacing-2xl)] min-w-0">
  ...
  if (layout === "row") {
    return (
      <div className="flex flex-row w-full h-[750px] justify-center items-center bg-yellow-500 p-[var(--spacing-4xl)] gap-[var(--spacing-8xl)] min-w-0">
        <div className="relative w-1/2 h-full flex-shrink-0 overflow-hidden">
          <Image
            src="/InugrationalMural.jpg"
            alt="Inaugural mural at the intersection of 84th Street and Roosevelt Avenue in Jackson Heights"
  ...
  return (
    <div className="flex flex-col w-full h-[700px] bg-yellow-500 p-[var(--spacing-2xl)] gap-[var(--spacing-4xl)] min-w-0">
