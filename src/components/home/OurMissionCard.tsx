  ...
  return (
    <div className="flex flex-col w-full gap-[var(--spacing-2xl)] md:gap-[var(--spacing-4xl)] min-w-0">
      <div className="flex flex-col items-start gap-[var(--spacing-lg)] md:gap-[var(--spacing-xl)]">
        <h2 className="mobile-heading-5xl-bold md:hero-xs text-[var(--color-content-primary)]">
          About us
        </h2>
        <p className="mobile-text-xl-semibold md:web-text-3xl-semibold text-[var(--color-content-primary)]">
