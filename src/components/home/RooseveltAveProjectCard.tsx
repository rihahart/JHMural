...
export default function RooseveltAveProjectCard() {
  return (
    <div className="flex flex-col w-full bg-blue-600 p-[var(--spacing-xl)] md:p-[var(--spacing-2xl)] gap-[var(--spacing-xl)] md:gap-[var(--spacing-2xl)] min-w-0">
      <div className="flex flex-col items-start gap-[var(--spacing-lg)] md:gap-[var(--spacing-xl)]">
        <h2 className="mobile-heading-5xl-bold md:web-heading-5xl-bold text-[var(--color-content-primary-inverse)]">
          Roosevelt Ave Project
        </h2>
        <p className="mobile-text-xl-semibold md:web-text-2xl-semibold text-[var(--color-content-primary-inverse)]">
      ...
      <div className="relative w-full h-[240px] md:h-[324px] overflow-hidden">
        <Image
          src="/MuralJH.JPG"
