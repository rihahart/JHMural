    ...
    return (
      <div className="flex flex-col items-start gap-[var(--spacing-xl)]">
        ...
        <div className="flex flex-col gap-[var(--spacing-2xl)]">
          ...
          <p className="mobile-text-lg-medium text-[var(--color-content-primary)]">{description2}</p>
        </div>
    ...
    return (
      <div className="flex flex-col items-start align-stretch justify-center gap-[var(--spacing-2xl)]">
        ...
        <div className="flex flex-col gap-[var(--spacing-2xl)]">
          ...
          <p className="web-text-lg-medium text-[var(--color-content-primary)]">{description2}</p>
        </div>
        <div className="flex flex-col w-full">
             <div className="border-b-[2px] border-[var(--color-content-secondary)] ">
              <NavButton
    ...
    return (
      <div className="flex items-start align-stretch justify-center max-w-[1400px] gap-[var(--spacing-8xl)]">
        ...
        <div className="flex flex-col gap-[var(--spacing-2xl)]">
          ...
          <p className="web-text-xl-medium text-[var(--color-content-primary)]">{description2}</p>
        </div>
        <div className="flex flex-col w-full">
          <div className="border-b-[2px] border-[var(--color-content-secondary)] ">
            <NavButton
  ...
  return (
    ...
    <div className="flex flex-col items-start w-[60%] gap-[var(--spacing-2xl)]">
      <div className="flex flex-col gap-[var(--spacing-2xl)]">
        ...
        <p className="web-text-2xl-medium text-[var(--color-content-primary)]">{description2}</p>
      </div>
      <div className="flex flex-col w-full">
             <div className="border-b-[2px] border-[var(--color-content-secondary)] ">
              <NavButton
