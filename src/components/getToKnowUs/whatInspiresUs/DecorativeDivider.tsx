...
export default function DecorativeDivider() {
  return (
    <div className="relative flex items-center justify-center w-full gap-[var(--spacing-sm)] md:gap-[var(--spacing-m)] lg:gap-[var(--spacing-lg)]">
      <div className="flex-1 h-1 lg:h-1.5  bg-[var(--color-content-secondary)]" />
